...
insert into STORY (id, content, title, posted, blogger_id) VALUES (2,'várgokat kell ültetni Sanyibánál2', 'virág ültetés story', CURRENT_DATE(), (select id From BLOGGER where name = 'Sanko'));
